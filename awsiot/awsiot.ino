...
const char* ssid = "R&D LABS"; //Provide your SSID
const char* password = ""; // Provide Password
const char* mqtt_server = "a2lfk0nrz0agax-ats.iot.ap-south-1.amazonaws.com"; // Relace with your MQTT END point
...
void setup() {
  ...
  //=============================================
  // Cert file reading
  File file4 = SPIFFS.open("/511d94530b-certificate.pem.crt", "r");
  if (!file4) {
    Serial.println("Failed to open file for reading");
    return;
  }
  ...
  File file6 = SPIFFS.open("/511d94530b-private.pem.key", "r");
  if (!file6) {
    Serial.println("Failed to open file for reading");
    return;
  }
...
void loop() {
  float h = 56;   // Reading Temperature form DHT sensor
  float t =81;      // Reading Humidity form DHT sensor
  float tF = (t * 1.8) + 32;
  if (isnan(h) || isnan(t))
  {
